...
public extension CPLayoutAttribute {
    ...
    static private func relativeToSuperView(left: CPLayoutAttribute, relation: LayoutRelation, right: CGFloat, priority: LayoutPriority = LayoutPriorityHigh) -> NSLayoutConstraint? {
...
public extension CPLayoutAttribute {
    ...
    static private func relativeToAttribute(left: CPLayoutAttribute, relation: LayoutRelation, right: CPLayoutAttribute, priority: LayoutPriority = LayoutPriorityHigh) -> NSLayoutConstraint? {
